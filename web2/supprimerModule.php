...
<body>
    ...
    <?php 
        ...
        if($_POST)
        {
            ...
            if(!empty($numero) || !empty($nom))
            {
                if(!empty($nom))
                {
                    $resultat=mysqli_query($sum,"DELETE FROM module WHERE code_module=$nom");
                }
                else if(!empty($numero))
                {
                    $resultat=mysqli_query($sum,"DELETE FROM module WHERE code_module=$numero");
                }
                if($resultat==0)
                {
                    echo '
                    <div class="alert">
                        ...
                        <div>
                            ...
                            <label for="btn-alert"><a href="supprimerModule.php">FERMER</a></label>
                        </div>
                    </div>
                    ';
                }
    ...
    <section id="corps">
        <form action="" method="POST">
            ...
            <small>VEUILEZ ENTRER SOIT LE NUMERO DU MODULE, SOIT LE NOM DU MODULE</small>
            <span>Code: </span>
            <span>Nom: </span>
