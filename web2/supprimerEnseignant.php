...
<head>
    ...
    <title>Supprimmer un enseignant</title>
</head>
<body>
    <aside>
        ...
        if($_POST)
        {
            ...
            if(!empty($numero) || !empty($nom))
            {
                if(!empty($nom))
                {
                    $resultat=mysqli_query($sum,"DELETE FROM enseignant WHERE numero_enseignant=$nom");
                }
                else if(!empty($numero))
                {
                    $resultat=mysqli_query($sum,"DELETE FROM enseignant WHERE numero_enseignant=$numero");
                }
                if($resultat==0)
                {
                    echo '
                    <div class="alert">
                        ...
                        <div>
                            ...
                            <label for="btn-alert"><a href="supprimerEnseignant.php">FERMER</a></label>
                        </div>
                    </div>
                    ';
                }
    ...
    <section id="corps">
        <form action="" method="POST">
            ...
            <small>VEUILEZ ENTRER SOIT LE NUMERO DE L'ENSEIGNANT, SOIT LE NOM DE L'ENSEIGNANT</small>
            <span>Numéro: </span>
            <span>Nom: </span>
