...
<body>
    ...
    <?php 
        ...
        if($_POST)
        {
            ...
            if(!empty($numero))
            {
                $resultat=mysqli_query($sum,"DELETE FROM note WHERE num_note=$numero");
                if($resultat==0)
                {
                    echo '
                    <div class="alert">
                        ...
                        <div>
                            ...
                            <label for="btn-alert"><a href="supprimerNote.php">FERMER</a></label>
                        </div>
                    </div>
                    ';
                }
                else
                {
                    ...
                    <div class="alert">
                        ...
                        <div>
                            ...
                            <h3>La note  est supprimé avec succes de la base</h3>
                            <h3>Merci</h3>
                            <label for="btn-alert"><a href="supprimerNote.php">FERMER</a></label>
                        </div>
                    </div>
                ...
                echo '
                    <div class="alert">
                        ...
                        <div>
                            <img src="images/erreur.png">
                            <h3>UNE ERREUR S\'EST PRODUIT</h3>
                            <h3>VEUILEZ REMPLIR La CHAMPS .</h3>
                            <label for="btn-alert"><a href="supprimerNote.php">FERMER</a></label>
                        </div>
                    </div>
                    ';
