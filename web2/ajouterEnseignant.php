...
<body>
    ...
    if ($_POST) {
        ...
        $resultat = mysqli_query($sum, "INSERT INTO enseignant values($numero,'$nom','$sexe','$email',$telmobile,$telfixe,'$adresse','$grade')");
        if ($resultat == 0) {
            echo '
        <div class="alert">
            ...
            <div>
                ...
                <label for="btn-alert"><a href="ajouterEnseignant.php">FERMER</a></label>
            </div>
        </div>
        ';
        } else {
        ...
        <div class="alert">
            ...
            <div>
                ...
                <h3>L\' enseignant  est ajouté avec succes dans la base</h3>
                <h3>Merci</h3>
                <label for="btn-alert"><a href="ajouterEnseignant.php">FERMER</a></label>
            </div>
        </div>
    ...
    <section id="corps">
        <form action="" method="POST">
            ...
            <span>Numéro: </span>
            <span>Nom: </span>
            <input type="number" name="numero" placeholder="exemple: 024321" required>
            ...
            <input type="mail" name="email" placeholder="aliabdi@gmail.com">
            <span>Tel Mobile: </span>
            <span>Tel Fixe: </span>
            <input type="number" name="telmobile" placeholder="77 12 34 56" required>
            <input type="number" name="telfixe" placeholder="21 98 34 56" required>
            <span>Adresse: </span>
            <span>Grade: </span>
            <input type="text" name="adresse" placeholder="CITE WADAJIR 1 LOT 105" required>
            <input type="text" name="grade" placeholder="Maitre de conference">
            <div id="button">
