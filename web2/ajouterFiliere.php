...
<body>
    ...
    <?php 
        if($_POST)
        {
            ...
            $resultat = mysqli_query($sum,"INSERT INTO filiere values($numero,'$nom')");
      if($resultat==0)
      {
        echo '
        <div class="alert">
            ...
            <div>
                ...
                <label for="btn-alert"><a href="ajouterFiliere.php">FERMER</a></label>
            </div>
        </div>
        ';
      }
      else
      {
        ...
        <div class="alert">
            ...
            <div>
                ...
                <h3>Le filiere est ajouté avec succes dans la base</h3>
                <h3>Merci</h3>
                <label for="btn-alert"><a href="ajouterFiliere.php">FERMER</a></label>
            </div>
        </div>
    ...
    <section id="corps">
        <form action="" method="POST">
            <h2>Ajouter un nouveau filiere</h2>
            <span>Numéro: </span>
            <span>Nom: </span>
            <input type="number" name="numero" placeholder="exemple: 4321" required>
            <input type="text" name="nom" placeholder="INFORMATIQUE" required>
            <div id="button">
