...
<aside>
    ...
    <?php 
        ...
        if($_POST)
        {
            ...
            $resultat = mysqli_query($sum,"INSERT INTO module values($code,'$nom',$coefficient,$volume,$filiere)");
            if($resultat==0)
            {
                echo '
                <div class="alert">
                    ...
                    <div>
                        ...
                        <label for="btn-alert"><a href="ajoutermodule.php">FERMER</a></label>
                    </div>
                </div>
                ';
            }
            else
            {
                ...
                <div class="alert">
                    ...
                    <div>
                        ...
                        <h3>Le module< est ajouté avec succes dans la base</h3>
                        <h3>Merci</h3>
                        <label for="btn-alert"><a href="ajoutermodule.php">FERMER</a></label>
                    </div>
                </div>
    ...
    <section id="corps">
        <form action="" method="POST">
            ...
            <span>Code: </span>
            <span>Nom: </span>
            <input type="number" name="code" placeholder="exemple: 4321" required>
            <input type="text" name="nom" placeholder="PROGRAMMATION WEB" required>
